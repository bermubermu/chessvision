class Problem < ActiveRecord::Base
  ...
  has_attached_file :picture, :styles => { :thumb=> "340x340#" }, :storage => :s3, :s3_credentials => "#{RAILS_ROOT}/config/s3.yml", :url => "/:class/:attachment/:id/:style_:basename.:extension", :bucket => 'albertorecurso'
